...
if (enquiryType && workFields) {
    ...
    enquiryType.addEventListener("change", toggleWorkFields);

    // Make sure the correct state is shown if the page reloads
    toggleWorkFields();
}
